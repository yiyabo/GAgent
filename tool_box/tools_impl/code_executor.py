...
def _build_qwen_code_command(
    *,
    ...
    enhanced_task = (
        ...
        f"If upstream data or dependencies are missing or incomplete, you are "
        f"AUTHORIZED to produce or fix them as part of completing this task. "
        f"Do NOT stop and report BLOCKED_DEPENDENCY — instead, inspect what "
        f"is available, generate the missing inputs, then proceed.\n"
