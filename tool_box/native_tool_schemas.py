...
NATIVE_TOOL_CONTENT: Dict[str, Dict[str, Any]] = {
    ...
    "code_executor": {
        ...
        "description": (
            ...
            "DELEGATION to a coding agent that writes and debugs the code, not a local one-liner; "
            "which harness serves that delegation is deployment-configured. Errors are returned "
