...
from .exceptions import (
    ValidationError, BusinessError, SystemError, DatabaseError,
...
def evaluation_error(
    ...
    return ValidationError(
        message=f"评估{operation}失败",
        error_code=ErrorCode.FIELD_VALUE_OUT_OF_RANGE,
        cause=cause,
        context=context
    )
