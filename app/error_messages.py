        ...
        self._messages = {
            ...
            ErrorCode.GOAL_VALIDATION_FAILED: {
                ...
                Language.EN_US: {
                    ...
                    'suggestions': ['Check goal format', 'Ensure complete goal content', 'Reference goal setting guide']
                }
            },
            ...
            ErrorCode.MISSING_REQUIRED_FIELD: {
                ...
                Language.EN_US: {
                    ...
                    'suggestions': ['Check all required fields', 'Reference API documentation', 'Add missing parameters']
                }
            },
            ...
            ErrorCode.INVALID_FIELD_FORMAT: {
                ...
                Language.EN_US: {
                    ...
                    'suggestions': ['Check field format requirements', 'Use correct data type', 'Reference format examples']
                }
            },
            ...
            ErrorCode.INVALID_JSON_FORMAT: {
                ...
                Language.EN_US: {
                    ...
                    'suggestions': ['Check JSON syntax', 'Use JSON validation tool', 'Ensure proper quotes and brackets']
                }
            },
            ...
            ErrorCode.TIMEOUT_ERROR: {
                ...
                Language.EN_US: {
                    ...
                    'suggestions': ['Increase timeout duration', 'Optimize operation efficiency', 'Process data in batches']
                }
            },
            ...
            ErrorCode.DATABASE_CONNECTION_FAILED: {
                ...
                Language.EN_US: {
                    ...
                    'suggestions': ['Check database service status', 'Verify connection configuration', 'Check network connectivity']
                }
            },
            ...
            ErrorCode.INSUFFICIENT_PERMISSIONS: {
                ...
                Language.EN_US: {
                    ...
                    'suggestions': ['Contact admin for permissions', 'Verify user role', 'Check permission configuration']
                }
            },
    ...
    def get_message(
        ...
        if error_code not in self._messages:
            ...
            return {
                ...
                'description': f'错误码 {error_code} 未定义' if lang == Language.ZH_CN else f'Error code {error_code} not defined',
