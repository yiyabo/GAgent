...
class ContentEvaluator:
    ...
    def _is_too_generic(self, content: str) -> bool:
        ...
        generic_phrases = [
            'in general', 'usually', 'often', 'sometimes', 'many', 'various',
            'it depends', 'may be', 'could be', 'might be'
        ]
        content_lower = content.lower()
    ...
    def _has_scientific_terms(self, content: str) -> bool:
        ...
        scientific_indicators = [
            'study', 'research', 'analysis', 'method', 'result', 'data',
            'experiment', 'hypothesis', 'theory', 'observation', 'measurement'
        ]
        content_lower = content.lower()
    ...
    def _has_methodological_language(self, content: str) -> bool:
        """Check for methodological language"""
        method_indicators = [
            'protocol', 'procedure', 'approach', 'technique', 'methodology',
            'conducted', 'performed', 'measured', 'analyzed', 'evaluated'
        ]
        content_lower = content.lower()
