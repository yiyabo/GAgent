...
PROMPTS_ZH_CN = {
    ...
    "evaluation": {
        "dimensions": {
            "relevance": {"name": "相关性", "description": "内容与任务的相关程度"},
            "completeness": {"name": "完整性", "description": "内容的完整性和充实度"},
            "accuracy": {"name": "准确性", "description": "内容的事实准确性和可信度"},
            "clarity": {"name": "清晰度", "description": "表达的清晰度和可读性"},
            "coherence": {"name": "连贯性", "description": "逻辑连贯性和结构合理性"},
            "scientific_rigor": {"name": "科学严谨性", "description": "科学方法和术语的规范性"},
        },
        "instructions": {
        ...
        "quality_levels": {"excellent": "优秀", "good": "良好", "fair": "一般", "poor": "较差"},
    },
    # ============== 专家角色 (Expert Roles) ==============
    "expert_roles": {
    ...
    "adversarial": {
        ...
        "severity_levels": {"high": "高", "medium": "中", "low": "低"},
    ...
    "meta_evaluation": {
        ...
        "health_suggestions": ["提高评估标准的一致性", "加强认知偏见控制", "增加评估样本量以提高可靠性"],
        "error_messages": {"no_history": "无评估历史可供分析", "evaluation_error": "元评估出错: {error}"},
    },
    # ============== 状态和标签 (Status and Labels) ==============
    "status": {
        "trends": {"improving": "改进中", "declining": "下降", "stable": "稳定", "insufficient_data": "数据不足"},
        "stability": {
            "very_stable": "非常稳定",
