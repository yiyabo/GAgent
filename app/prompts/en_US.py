...
PROMPTS_EN_US = {
    ...
    "evaluation": {
        "dimensions": {
            "relevance": {
                "name": "Relevance",
                "description": "How well the content relates to the task requirements"
            },
            "completeness": {
                "name": "Completeness", 
            ...
            "clarity": {
                "name": "Clarity",
                "description": "The clearness and readability of the expression"
            },
            "coherence": {
                "name": "Coherence",
                "description": "The logical consistency and structural soundness"
            },
            "scientific_rigor": {
    ...
    "expert_roles": {
        "theoretical_biologist": {
            ...
            "focus_areas": ["Biological mechanisms", "Theoretical foundations", "Scientific principles", "Molecular mechanisms"],
