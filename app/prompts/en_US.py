        ...
        "guidelines": {
            ...
            "scenario_rules": {
                "bound": [
                    ...
                    "Use `web_search`, `sequence_fetch`, `graph_rag`, `phagescope`, or `bio_tools` when the user explicitly requests those capabilities, or when minimal external verification/attachment-backed evidence is necessary for factual accuracy.",
