...
class DatabaseParamsHandler:
    ...
    def add_arguments(parser: ArgumentParser) -> None:
        ...
        group.add_argument(
            '--db-optimize',
            action='store_true',
            help='Optimize database performance (indexes, vacuum, analyze)'
        )
        ...
        group.add_argument(
            '--db-reset',
            action='store_true',
            help='Reset database (DESTRUCTIVE - clears all data)'
        )
        ...
        task_group.add_argument(
            ...
            dest='task_id',
            type=int,
            help='Task ID for operations requiring task reference'
        )
        task_group.add_argument(
            '--list-children', 
            action='store_true',
            help='List child tasks of a specific task (requires --task-id)'
        )
        task_group.add_argument(
            '--get-subtree', 
            action='store_true',
            help='Get task subtree structure (requires --task-id)'
        )
        task_group.add_argument(
            '--move-task', 
            action='store_true',
            help='Move task to new parent (requires --task-id and --new-parent-id)'
        )
        task_group.add_argument(
            '--new-parent-id', 
            dest='new_parent_id',
        ...
        rerun_group.add_argument(
            '--rerun-subtree', 
            type=int,
            help='Rerun task and all its subtasks by root task ID'
        )
        rerun_group.add_argument(
