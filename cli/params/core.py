...
class CoreParamsHandler:
    ...
    def add_arguments(parser: ArgumentParser) -> None:
        ...
        group.add_argument(
            '--goal', 
            type=str, 
            help='Project goal to plan for (required for new plans)'
        )
        group.add_argument(
            '--title', 
            type=str,
        ...
        group.add_argument(
            '--plan-only', 
            action='store_true',
            help='Generate plan without execution'
        )
        group.add_argument(
            '--execute-only', 
            action='store_true',
        ...
        group.add_argument(
            '--no-open', 
            action='store_true',
            help='Skip editor opening for plan review'
        )
        ...
        group.add_argument(
            ...
            default='bfs',
            help='Task execution order (default: bfs)'
        )
        ...
        group.add_argument(
            ...
            type=str,
            default='output.md',
            help='Assembled output file path (default: output.md)'
        )
