...
class ContextParamsHandler:
    ...
    def add_arguments(parser: ArgumentParser) -> None:
        ...
        group.add_argument("--use-context", action="store_true", help="Enable context-aware task execution")
        ...
        semantic_group.add_argument(
            "--min-similarity", dest="min_similarity", type=float, help="Minimum similarity threshold (0.0-1.0)"
        )
