...
class TestStructureContrastiveLearningDataGenerator:
    ...
    def test_export_json(self, generator):
        ...
        samples = [
            ContrastiveSample(
                anchor_id=1, anchor_text="anchor text",
                positive_id=2, positive_text="positive text",
                negative_id=3, negative_text="negative text",
                relation_type="requires", similarity_score=0.8
            )
        ]
    ...
    def test_get_statistics(self, generator):
        ...
        samples = [
            ContrastiveSample(
                anchor_id=1, anchor_text="text1",
                positive_id=2, positive_text="text2",
                negative_id=3, negative_text="text3",
                relation_type="requires", similarity_score=0.8
            ),
            ContrastiveSample(
                anchor_id=1, anchor_text="text1",
                positive_id=4, positive_text="text4",
                negative_id=5, negative_text="text5",
                relation_type="refers", similarity_score=0.6
            )
        ]
    ...
    def test_contrastive_sample_dataclass(self):
        ...
        sample = ContrastiveSample(
            anchor_id=1, anchor_text="anchor",
            positive_id=2, positive_text="positive",
            negative_id=3, negative_text="negative",
            relation_type="requires", similarity_score=0.8
        )
