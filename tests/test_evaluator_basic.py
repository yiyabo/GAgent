...
from app.models import EvaluationConfig, EvaluationDimensions
...
def test_basic_evaluator():
    ...
    print(f"✓ Dimensions evaluated: relevance={result.dimensions.relevance:.3f}, completeness={result.dimensions.completeness:.3f}")
